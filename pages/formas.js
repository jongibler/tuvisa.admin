...
function btnPlusPerson_click(btn) {
    $('#personsTable').append('<tr> <td><input class="form-control " placeholder="Nombre de la persona... "></td> <td><div class="col-sm-2"><button class="btn btn-danger btn-remove" onclick="return false; ">X</button></div></td> </tr>');
};